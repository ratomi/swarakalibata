                ...
                <div class="card-body">
                  ...
                  <?php 
                    ...
                    echo "<input type='hidden' name='id' value='".$row[id_logo]."'>
                          <tr><td width=120px>Logo Terpasang</td><td style='background:#e3e3e3'><img width='100%' src='".base_url()."asset/logo/$row[gambar]'></td></tr>
                          <tr><td>Ganti Logo</td><td><a href='".base_url()."asset/logo/$row[gambar]' target=_blank>".$row[gambar]."</a><input type='file' name='gambar_logo' class='form-control'>
                          </td></tr>";
                      $no++;
                    }
