<div class="main-page left">
	<div class="double-block">
		<div class="content-block main right">
			...
			<?php
				$ia = $this->model_utama->view_where_ordering_limit('iklantengah',array('posisi'=>'home', 'aktif'=>'Y'),'id_iklantengah','ASC',0,1)->row_array();
...
<?php 
$advetorial = $this->model_utama->view_where_ordering_limit('iklantengah',array('posisi'=>'home_tengah', 'aktif'=>'Y'),'id_iklantengah','ASC',0,6);
...
<div class="main-page left">
	<div class="double-block">
		<div class="content-block main right">
			...
			<?php
				$ic = $this->model_utama->view_where_ordering_limit('iklantengah',array('posisi'=>'home', 'aktif'=>'Y'),'id_iklantengah','ASC',1,1)->row_array();
			...
			<?php $ra = $this->model_utama->view_where('kategori',array('sidebar' => 2))->row_array(); ?>
				<div class="block-title" style="background: #2182b4;">
					...
					<h2>&nbsp;<?php echo "$ra[nama_kategori]"; ?></h2>
				</div>
				<div class="block-content">
					<?php 
...
<div class="main-page left">
	<div class="double-block">
		<div class="content-block main right">
			...
			<?php
				$ic = $this->model_utama->view_where_ordering_limit('iklantengah',array('posisi'=>'home', 'aktif'=>'Y'),'id_iklantengah','ASC',2,1)->row_array();
				echo "<a href='$ic[url]' target='_blank'>";
					$string = $ic['gambar'];
					if ($ic['gambar'] != ''){
						if(preg_match("/swf\z/i", $string)) {
