...
<div class="wrapper">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2018-<?php echo date('Y'); ?> <a target='_BLANK' href="<?php echo base_url(); ?>"><?php echo $iden['nama_website']; ?></a>.</strong>
    All rights reserved.
...
<script>
  $(function () {
    $("#example1").DataTable({
      "language": {
          "url":"<?php echo base_url(); ?>asset/admin_mu/plugins/datatables/Indonesian.json"
    }});
    ...
    $('#example2').DataTable({
      ...
      "info": true,
      "language": {
          "url":"<?php echo base_url(); ?>aasset/admin_mu/plugins/datatables-bs4/js/Indonesian.json"
      },
      "autoWidth": false,
