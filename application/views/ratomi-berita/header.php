...
<div class='wrapper'>			
	<div class='header-logo'>";
	  ...
	  foreach ($logo->result_array() as $row) {
		echo "<a href='".base_url()."'><img style='max-height:75px' src='".base_url()."asset/logo/$row[gambar]'/></a>";
	  }
echo "</div>	
<!--
	...
	<div class='header-addons'>
		...
		<div class='header-search'>
			".form_open('berita/index')."
				<input type='text' placeholder='Pencarian..'' name='kata' class='search-input' required/>
	        ...
	        if (isset($menu['parents'][$parent])) {
	        	if ($parent=='0'){
		            $html .= "<ul class='the-menu'>
		            			<li><a href='".base_url()."' style='background: url(".base_url()."asset/images/home.png) no-repeat center; font-size:0; width:34px;'>&nbsp;</a></li>";
		        }else{
		        	$html .= "<ul>";
		        }
