...
<div class="full-width">
	<div class="article-title">
		<div class="share-block right">
			...
			<div>
				<a href="javascript:printArticle();" class="small-button"><span class="icon-text">&#59158;</span>&nbsp;&nbsp;Cetak</a>
				<a href="#" class="small-button"><span class="icon-text">&#9993;</span>&nbsp;&nbsp;E-mail</a>
			</div>
		</div>
		...
		<div class="content-block main left">
			...
			<?php if ($total_komentar>='1'){ ?>
				<div id="viewcomment listcomment" class="block-title">
					<a href="#writecomment" class="right">Tuliskan Komentar</a>
