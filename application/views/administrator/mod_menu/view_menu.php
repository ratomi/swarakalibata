                  ...
                  <div class="dd" id="nestable">
                      ...
                      function get_menu($items,$class = 'dd-list') {
                          ...
                          foreach($items as $key=>$value) {
                            if ($value['aktif']=='Ya'){ $iconp = 'fa-check-circle text-info'; $aktip ='Menu Aktif'; }else{ $iconp = 'fa-times-circle text-danger';  $aktip ='Menu Non Aktif'; }
                              ...
                              $html.= '<li class="dd-item dd3-item" data-id="'.$value['id_menu'].'" >
                                          ...
                                          <div class="dd3-content"><span id="label_show'.$value['id_menu'].'">'.$value['nama_menu'].'</span> 
                                              <span class="span-right">/<span id="link_show'.$value['id_menu'].'">'.$value['link'].'</span> &nbsp;&nbsp; 
                                                  ...
                                                  <a title="'.$aktip.'" href="'.base_url().'/'.$ci->uri->segment(1).'/aktif_menuwebsite/'.$value['id_menu'].'" style="cursor:pointer"><i class="fa '.$iconp.'"></i></a> &nbsp;
