                  ...
                  <tbody>
                    ...
                    if ($this->session->level == 'admin'){
                      ...
                      <tr><th scope='row'>Hak Akses</th>                    <td><div class='checkbox-scroll'>";
                                                                               foreach ($akses as $ro){
                                                                                 echo "<span style='display:block'><a class='text-danger' href='".base_url()."administrator/delete_akses/$ro[id_umod]/".$this->uri->segment(3)."'><span class='fa fa-times-circle text-danger'></span></a>&nbsp; $ro[nama_modul]</span> ";
                                                                               }
                      echo "</div></td></tr>";
                    }
                  echo "</tbody>
